...
gt_file_keywords = ["gTruth-wnw-", ".mat"];
...
for k = 1:length(gt_dirs)
    ...
    file_id = fopen(gt_dirs(k)+"/gTruth-wnw.csv","w");
    fprintf(file_id,"name,activity,person,W,H,FPS,w0,h0,f0,w,h,f\n");
